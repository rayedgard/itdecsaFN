...
$consulta = mysql_query("select imagen, file from tsistemas where id='$codigo'",$link);
...
mysql_query("DELETE FROM tsistemas WHERE id='$codigo' ",$link);
	unlink("../imagenes/sistemas/".$imagen[0]);//para eliminar la imagen 
	unlink("../imagenes/sistemas/".$imagen[1]);//para eliminar el archivo 
$my_error = mysql_error($link);
	}
	if($estado=='1')
	{
mysql_query("UPDATE tsistemas SET  estado='1' WHERE id='$codigo'",$link);
$my_error = mysql_error($link);
	}
	
	if($estado=='0')
	{
mysql_query("UPDATE tsistemas SET  estado='0' WHERE id='$codigo'",$link);
$my_error = mysql_error($link);
	}
