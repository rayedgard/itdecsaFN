...
insert  into `tcliente`(`id`,`nombres`,`telefono`,`correo`,`pass`,`estado`) values (1,'Edgard Rayme Quispe','8585474855','rayedgard@gmail.com','123456',0);
...
/*Table structure for table `tfotopublicidad` */

DROP TABLE IF EXISTS `tfotopublicidad`;

CREATE TABLE `tfotopublicidad` (
  `foto` char(200) NOT NULL,
  `idpublicidad` int(8) DEFAULT NULL,
  PRIMARY KEY (`foto`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Data for the table `tfotopublicidad` */

LOCK TABLES `tfotopublicidad` WRITE;
...
CREATE TABLE `tpublicidad` (
  `id` int(8) NOT NULL AUTO_INCREMENT,
  `nombre` varchar(200) DEFAULT NULL,
  `fotoFondo` varchar(200) DEFAULT NULL,
...
/*Data for the table `tpublicidad` */

LOCK TABLES `tpublicidad` WRITE;

insert  into `tpublicidad`(`id`,`nombre`,`fotoFondo`,`tiempo`,`precio`,`estado`) values (7,'1','valle-sagrado0-g.jpg','2015-10-29',123,1),(8,'sistema de control de asistencia ','Untitled.gif','2015-10-31',123,1);
...
insert  into `tsistemas`(`id`,`nombre`,`imagen`,`descripcion`,`file`,`tecnicas`,`requisitos`,`icono`,`estado`) values (2,'Sistema de Control de Asistencia y Permanencia de Personal para entidades publicas','control de asistencia _n.jpg','<p>Descripci&oacute;n... sisitemas de control de asistencia</p>','EEPP Cambio denominaciÃ³n social.pdf','<p>Especificaciones t&eacute;cnicas... &nbsp;dd</p>','<p>Requisitos minimos...fdsfs</p>',NULL,0),(3,'Sistema de Ventas y Facturacion','facebook1.jpg','<p>Descripci&oacute;n...ddddddddd</p>','02 Servicios tÃ©cnicos.xlsx','<p>Especificaciones t&eacute;cnicas...dsd</p>','<p>Requisitos minimos...dsd</p>','logoicpna.png',0);
